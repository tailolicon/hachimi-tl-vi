...
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,699/2,463/2,358**; 15,610 / 19,520 currently resolved (79.97%); current generation **67 / 206 batches (32.52%)**, 1,080 merged decisions; 3,910 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
| Audit merge backlog | **13 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
