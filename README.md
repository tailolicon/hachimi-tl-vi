...
| Pinned source coverage | **28,040 / 1,158,825 (2.42%)** — 1,130,785 remaining |
| Current translation wave | **28,040 / 131,560 (21.31%)** — 103,520 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,829/2,329/2,362**; 16,897 / 19,520 currently resolved (86.56%); current generation **60 / 135 batches (44.44%)**, 1,140 merged decisions; 2,623 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
