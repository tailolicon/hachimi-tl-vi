...
| Pinned source coverage | **24,240 / 1,158,825 (2.09%)** — 1,134,585 remaining |
| Current translation wave | **24,240 / 131,560 (18.43%)** — 107,320 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,661/2,466/2,393**; 15,604 / 19,520 currently resolved (79.94%); current generation **11 / 197 batches (5.58%)**, 160 merged decisions; 3,916 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
