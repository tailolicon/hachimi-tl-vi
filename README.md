...
| Pinned source coverage | **20,740 / 1,158,825 (1.79%)** — 1,138,085 remaining |
| Current translation wave | **20,740 / 131,560 (15.76%)** — 110,820 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,644/2,443/2,433**; 15,345 / 19,520 currently resolved (78.61%); current generation **62 / 218 batches (28.44%)**, 1,000 merged decisions; 4,175 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
...
| Context curation | Speech **100.00%**, terminology **96.28%** |
| Active worker claims | **17** |
