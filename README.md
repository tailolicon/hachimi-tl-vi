...
| Pinned source coverage | **25,740 / 1,158,825 (2.22%)** — 1,133,085 remaining |
| Current translation wave | **25,740 / 131,560 (19.57%)** — 105,820 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,699/2,463/2,358**; 15,610 / 19,520 currently resolved (79.97%); current generation **65 / 206 batches (31.55%)**, 1,080 merged decisions; 3,910 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
