...
| Pinned source coverage | **29,020 / 1,158,825 (2.50%)** — 1,129,805 remaining |
| Current translation wave | **29,020 / 131,560 (22.06%)** — 102,540 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,777/2,350/2,393**; 16,812 / 19,520 currently resolved (86.13%); current generation **10 / 136 batches (7.35%)**, 120 merged decisions; 2,708 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
