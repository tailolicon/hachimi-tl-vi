...
| Primary integration lane | **Final high-frequency canonical conflict and overmatch sweep** — stage **domain_work** (`canonical-final-conflict-sweep`) |
| Canonical parallelism | **ON** — domain work parallel / integration serial; 0 active-or-claimable domain lanes, 0 ready for integration, 6 canonical domains complete; configured domain-worker cap 5 |
...
**Roadmap:** ▶ Final high-frequency canonical conflict and overmatch sweep
