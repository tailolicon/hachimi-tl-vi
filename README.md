...
| Pinned source coverage | **24,580 / 1,158,825 (2.12%)** — 1,134,245 remaining |
| Current translation wave | **24,580 / 131,560 (18.68%)** — 106,980 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,660/2,475/2,385**; 15,623 / 19,520 currently resolved (80.04%); current generation **11 / 195 batches (5.64%)**, 0 merged decisions; 3,897 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
