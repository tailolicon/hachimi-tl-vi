...
| Pinned source coverage | **28,720 / 1,158,825 (2.48%)** — 1,130,105 remaining |
| Current translation wave | **28,720 / 131,560 (21.83%)** — 102,840 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,782/2,345/2,393**; 16,905 / 19,520 currently resolved (86.60%); current generation **44 / 131 batches (33.59%)**, 480 merged decisions; 2,615 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
| Audit merge backlog | **20 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
