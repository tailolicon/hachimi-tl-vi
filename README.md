...
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,646/2,443/2,431**; 17,072 / 19,520 currently resolved (87.46%); current generation **123 / 123 batches (100.00%)**, 1,051 merged decisions; 2,448 unresolved; gate **LOCKED** |
| Audit merge backlog | **70 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
| UI review | **0 / 6,455 reviewed items (0.00%)** |
| Context curation | Speech **100.00%**, terminology **96.68%** |
