...
| Pinned source coverage | **21,920 / 1,158,825 (1.89%)** — 1,136,905 remaining |
| Current translation wave | **21,920 / 131,560 (16.66%)** — 109,640 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,625/2,433/2,462**; 15,541 / 19,520 currently resolved (79.62%); current generation **100 / 218 batches (45.87%)**, 1,790 merged decisions; 3,979 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
