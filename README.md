...
| Pinned source coverage | **27,900 / 1,158,825 (2.41%)** — 1,130,925 remaining |
| Current translation wave | **27,900 / 131,560 (21.21%)** — 103,660 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,841/2,305/2,374**; 16,820 / 19,520 currently resolved (86.17%); current generation **27 / 135 batches (20.00%)**, 340 merged decisions; 2,700 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
