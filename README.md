...
| Pinned source coverage | **25,820 / 1,158,825 (2.23%)** — 1,133,005 remaining |
| Current translation wave | **25,820 / 131,560 (19.63%)** — 105,740 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,710/2,467/2,343**; 15,847 / 19,520 currently resolved (81.18%); current generation **64 / 190 batches (33.68%)**, 1,080 merged decisions; 3,673 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
