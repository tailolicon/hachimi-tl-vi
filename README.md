...
| Pinned source coverage | **26,460 / 1,158,825 (2.28%)** — 1,132,365 remaining |
| Current translation wave | **26,460 / 131,560 (20.11%)** — 105,100 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,937/2,273/2,310**; 16,241 / 19,520 currently resolved (83.20%); current generation **5 / 164 batches (3.05%)**, 20 merged decisions; 3,279 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
