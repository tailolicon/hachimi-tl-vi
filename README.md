...
| Pinned source coverage | **26,560 / 1,158,825 (2.29%)** — 1,132,265 remaining |
| Current translation wave | **26,560 / 131,560 (20.19%)** — 105,000 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,890/2,329/2,301**; 16,450 / 19,520 currently resolved (84.27%); current generation **61 / 164 batches (37.20%)**, 1,020 merged decisions; 3,070 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
