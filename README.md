...
| Pinned source coverage | **28,640 / 1,158,825 (2.47%)** — 1,130,185 remaining |
| Current translation wave | **28,640 / 131,560 (21.77%)** — 102,920 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,782/2,342/2,396**; 16,901 / 19,520 currently resolved (86.58%); current generation **19 / 131 batches (14.50%)**, 180 merged decisions; 2,619 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
