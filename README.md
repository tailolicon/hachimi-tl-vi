...
**Roadmap:** → Character / training-career UI terminology<br>✓→ Resources / gacha / shop terminology [ready for integration]<br>→ Missions / rewards / events terminology<br>→ Common system/UI player-facing terminology<br>→ Final high-frequency canonical conflict and overmatch sweep
