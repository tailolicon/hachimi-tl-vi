...
| Pinned source coverage | **38,080 / 1,158,825 (3.29%)** — 1,120,745 remaining |
| Current translation wave | **38,080 / 131,560 (28.94%)** — 93,480 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,779/2,415/2,326**; 16,665 / 19,520 currently resolved (85.37%); current generation **15 / 143 batches (10.49%)**, 0 merged decisions; 2,855 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
