...
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,883/2,345/2,292**; 16,738 / 19,520 currently resolved (85.75%); current generation **127 / 164 batches (77.44%)**, 2,259 merged decisions; 2,782 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
| Audit merge backlog | **14 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
