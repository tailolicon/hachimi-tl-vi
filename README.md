...
| Pinned source coverage | **37,860 / 1,158,825 (3.27%)** — 1,120,965 remaining |
| Current translation wave | **37,860 / 131,560 (28.78%)** — 93,700 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,776/2,414/2,330**; 16,740 / 19,520 currently resolved (85.76%); current generation **7 / 139 batches (5.04%)**, 0 merged decisions; 2,780 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
