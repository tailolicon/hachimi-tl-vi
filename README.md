...
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,646/2,443/2,431**; 17,072 / 19,520 currently resolved (87.46%); current generation **99 / 123 batches (80.49%)**, 1,051 merged decisions; 2,448 unresolved; gate **LOCKED** |
| Audit merge backlog | **46 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
