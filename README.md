...
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,876/2,441/2,203**; 16,203 / 19,520 currently resolved (83.01%); current generation **123 / 190 batches (64.74%)**, 2,274 merged decisions; 3,317 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
| Audit merge backlog | **9 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
