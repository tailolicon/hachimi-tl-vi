...
| Pinned source coverage | **28,880 / 1,158,825 (2.49%)** — 1,129,945 remaining |
| Current translation wave | **28,880 / 131,560 (21.95%)** — 102,680 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,777/2,350/2,393**; 16,850 / 19,520 currently resolved (86.32%); current generation **6 / 134 batches (4.48%)**, 60 merged decisions; 2,670 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
