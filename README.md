...
| Pinned source coverage | **25,720 / 1,158,825 (2.22%)** — 1,133,105 remaining |
| Current translation wave | **25,720 / 131,560 (19.55%)** — 105,840 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,696/2,462/2,362**; 15,577 / 19,520 currently resolved (79.80%); current generation **50 / 206 batches (24.27%)**, 920 merged decisions; 3,943 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
