...
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,834/2,442/2,244**; 16,093 / 19,520 currently resolved (82.44%); current generation **104 / 190 batches (54.74%)**, 1,914 merged decisions; 3,427 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
| Audit merge backlog | **8 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
| UI review | **0 / 6,459 reviewed items (0.00%)** |
| Context curation | Speech **100.00%**, terminology **95.49%** |
| Active worker claims | **35** |
