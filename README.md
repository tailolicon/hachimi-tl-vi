...
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,886/2,360/2,274**; 16,574 / 19,520 currently resolved (84.91%); current generation **107 / 164 batches (65.24%)**, 1,919 merged decisions; 2,946 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
| Audit merge backlog | **11 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
| UI review | **0 / 6,459 reviewed items (0.00%)** |
| Context curation | Speech **100.00%**, terminology **95.49%** |
| Active worker claims | **14** |
