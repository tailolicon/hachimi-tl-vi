...
| Pinned source coverage | **29,040 / 1,158,825 (2.51%)** — 1,129,785 remaining |
| Current translation wave | **29,040 / 131,560 (22.07%)** — 102,520 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,777/2,350/2,393**; 16,369 / 19,520 currently resolved (83.86%); current generation **11 / 158 batches (6.96%)**, 60 merged decisions; 3,151 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
