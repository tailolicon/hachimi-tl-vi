...
| Pinned source coverage | **20,040 / 1,158,825 (1.73%)** — 1,138,785 remaining |
| Current translation wave | **20,040 / 131,560 (15.23%)** — 111,520 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,632/2,451/2,437**; 15,271 / 19,520 currently resolved (78.23%); current generation **40 / 218 batches (18.35%)**, 600 merged decisions; 4,249 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
