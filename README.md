...
| Pinned source coverage | **25,760 / 1,158,825 (2.22%)** — 1,133,065 remaining |
| Current translation wave | **25,760 / 131,560 (19.58%)** — 105,800 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,708/2,457/2,355**; 15,729 / 19,520 currently resolved (80.58%); current generation **82 / 206 batches (39.81%)**, 1,563 merged decisions; 3,791 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
