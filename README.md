...
| Pinned source coverage | **26,260 / 1,158,825 (2.27%)** — 1,132,565 remaining |
| Current translation wave | **26,260 / 131,560 (19.96%)** — 105,300 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,937/2,273/2,310**; 16,714 / 19,520 currently resolved (85.62%); current generation **164 / 190 batches (86.32%)**, 3,094 merged decisions; 2,806 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
