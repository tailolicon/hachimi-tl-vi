...
| Canonical parallelism | **ON** — domain work parallel / integration serial; 1 active-or-claimable domain lanes, 2 ready for integration, 3 canonical domains complete; configured domain-worker cap 5 |
...
**Roadmap:** ✓→ Character / training-career UI terminology [ready for integration]<br>✓→ Missions / rewards / events terminology [ready for integration]<br>▶ Common system/UI player-facing terminology<br>→ Final high-frequency canonical conflict and overmatch sweep
