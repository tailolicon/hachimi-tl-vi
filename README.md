...
| Pinned source coverage | **25,800 / 1,158,825 (2.23%)** — 1,133,025 remaining |
| Current translation wave | **25,800 / 131,560 (19.61%)** — 105,760 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,708/2,458/2,354**; 15,747 / 19,520 currently resolved (80.67%); current generation **29 / 190 batches (15.26%)**, 500 merged decisions; 3,773 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
