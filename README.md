...
| Pinned source coverage | **37,940 / 1,158,825 (3.27%)** — 1,120,885 remaining |
| Current translation wave | **37,940 / 131,560 (28.84%)** — 93,620 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,776/2,414/2,330**; 16,740 / 19,520 currently resolved (85.76%); current generation **10 / 139 batches (7.19%)**, 140 merged decisions; 2,780 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
...
| Context curation | Speech **100.00%**, terminology **99.60%** |
