...
| Pinned source coverage | **25,260 / 1,158,825 (2.18%)** — 1,133,565 remaining |
| Current translation wave | **25,260 / 131,560 (19.20%)** — 106,300 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,660/2,475/2,385**; 15,421 / 19,520 currently resolved (79.00%); current generation **10 / 205 batches (4.88%)**, 140 merged decisions; 4,099 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
