...
| Pinned source coverage | **22,440 / 1,158,825 (1.94%)** — 1,136,385 remaining |
| Current translation wave | **22,440 / 131,560 (17.06%)** — 109,120 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,660/2,427/2,433**; 15,539 / 19,520 currently resolved (79.61%); current generation **13 / 200 batches (6.50%)**, 180 merged decisions; 3,981 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
