...
| Pinned source coverage | **23,580 / 1,158,825 (2.03%)** — 1,135,245 remaining |
| Current translation wave | **23,580 / 131,560 (17.92%)** — 107,980 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,661/2,450/2,409**; 15,588 / 19,520 currently resolved (79.86%); current generation **36 / 200 batches (18.00%)**, 581 merged decisions; 3,932 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
