...
| Pinned source coverage | **28,300 / 1,158,825 (2.44%)** — 1,130,525 remaining |
| Current translation wave | **28,300 / 131,560 (21.51%)** — 103,260 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,829/2,330/2,361**; 16,843 / 19,520 currently resolved (86.29%); current generation **10 / 134 batches (7.46%)**, 120 merged decisions; 2,677 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
