...
| Pinned source coverage | **22,120 / 1,158,825 (1.91%)** — 1,136,705 remaining |
| Current translation wave | **22,120 / 131,560 (16.81%)** — 109,440 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,660/2,427/2,433**; 15,697 / 19,520 currently resolved (80.41%); current generation **110 / 218 batches (50.46%)**, 2,110 merged decisions; 3,823 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
