...
| Pinned source coverage | **26,520 / 1,158,825 (2.29%)** — 1,132,305 remaining |
| Current translation wave | **26,520 / 131,560 (20.16%)** — 105,040 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,937/2,273/2,310**; 16,241 / 19,520 currently resolved (83.20%); current generation **19 / 164 batches (11.59%)**, 320 merged decisions; 3,279 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
