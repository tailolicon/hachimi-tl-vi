...
| Translation Audit Round 1 | **13,712 / 19,520 entries reviewed at least once (70.25%)** — ledger keep/revise/defer **9,374/2,198/2,140**; 10,293 / 19,520 currently resolved (52.73%); current generation **97 / 475 batches (20.42%)**, 960 merged decisions; 9,227 unresolved; gate **LOCKED** |
| Audit merge backlog | **49 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
