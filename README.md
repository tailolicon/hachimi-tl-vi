...
| Translation Audit Round 1 | **11,120 / 19,520 entries reviewed at least once (56.97%)** — ledger keep/revise/defer **7,410/2,002/1,708**; 7,969 / 19,520 currently resolved (40.82%); current generation **274 / 756 batches (36.24%)**, 4,874 merged decisions; 11,551 unresolved; gate **LOCKED** |
| Audit merge backlog | **30 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
