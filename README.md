...
| Pinned source coverage | **22,980 / 1,158,825 (1.98%)** — 1,135,845 remaining |
| Current translation wave | **22,980 / 131,560 (17.47%)** — 108,580 queued remaining |
| Deferred pinned entries | **1,027,265** — these must be promoted in later deterministic waves, not ignored |
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,659/2,440/2,421**; 15,566 / 19,520 currently resolved (79.74%); current generation **22 / 200 batches (11.00%)**, 360 merged decisions; 3,954 unresolved; gate **REVIEW ACTIVE / TRANSLATION OPEN** |
