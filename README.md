...
| Translation Audit Round 1 | **19,520 / 19,520 entries reviewed at least once (100.00%)** — ledger keep/revise/defer **14,618/2,450/2,452**; 15,616 / 19,520 currently resolved (80.00%); current generation **65 / 200 batches (32.50%)**, 800 merged decisions; 3,904 unresolved; gate **LOCKED** |
| Audit merge backlog | **25 completed batch** awaiting bounded reconciliation (normally ≤5 min) |
