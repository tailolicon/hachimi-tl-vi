...
def harden(repo_root: Path = REPO_ROOT) -> None:
    ...
    records = [
        ...
        {"id": "common_ui.all.common0020", "source_aliases": ["全部"], "preferred": "Tất cả", "accepted": ["Tất cả"], "compact": ["Tất cả"], "forbidden": [], "require_accepted": True, "source_paths": ["localize_dict.json"], "key_exact": ["Common0020"], "match_mode": "exact", "invalidation_scope": "item", "basis": "Common0020 is the generic All filter/selection label. Exact-key scope keeps generic all/every prose natural."},
        {"id": "common_ui.search.common0022", "source_aliases": ["搜索"], "preferred": "Tìm kiếm", "accepted": ["Tìm kiếm"], "compact": ["Tìm"], "forbidden": [], "require_accepted": True, "source_paths": ["localize_dict.json"], "key_exact": ["Common0022"], "match_mode": "exact", "invalidation_scope": "item", "basis": "Common0022 is the generic Search control. Exact-key scope avoids matching narrative search wording."},
        {"id": "common_ui.confirm.common0023", "source_aliases": ["决定"], "preferred": "Xác nhận", "accepted": ["Xác nhận"], "compact": ["Xác nhận"], "forbidden": [], "require_accepted": True, "source_paths": ["localize_dict.json"], "key_exact": ["Common0023"], "match_mode": "exact", "invalidation_scope": "item", "basis": "Common0023 is another generic Confirm/Decide control in the Common UI group; exact key prevents a global semantic flattening of decide."},
        {"id": "common_ui.default.common0030", "source_aliases": ["默认"], "preferred": "Mặc định", "accepted": ["Mặc định"], "compact": ["Mặc định"], "forbidden": [], "require_accepted": True, "source_paths": ["localize_dict.json"], "key_exact": ["Common0030"], "match_mode": "exact", "invalidation_scope": "item", "basis": "Common0030 is the generic Default label. Exact-key scope avoids imposing it on prose or resource-specific defaults."},
