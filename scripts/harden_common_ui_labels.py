...
def harden(repo_root: Path = REPO_ROOT) -> None:
    ...
    records = [
        {"id": "common_ui.close.common0007", "source_aliases": ["关闭"], "preferred": "Đóng", "accepted": ["Đóng"], "compact": ["Đóng"], "forbidden": [], "require_accepted": True, "source_paths": ["localize_dict.json"], "key_exact": ["Common0007"], "match_mode": "exact", "invalidation_scope": "item", "basis": "Common0007 is the generic Close control. Exact-key scope is required because the same source token also means Off at Common0093."},
        ...
        {"id": "common_ui.on.common0092", "source_aliases": ["开启"], "preferred": "Bật", "accepted": ["Bật"], "compact": ["Bật"], "forbidden": [], "require_accepted": True, "source_paths": ["localize_dict.json"], "key_exact": ["Common0092"], "match_mode": "exact", "invalidation_scope": "item", "basis": "Common0092 is the generic On toggle label. Exact-key scope avoids matching narrative enable/open wording."},
        {"id": "common_ui.off.common0093", "source_aliases": ["关闭"], "preferred": "Tắt", "accepted": ["Tắt"], "compact": ["Tắt"], "forbidden": [], "require_accepted": True, "source_paths": ["localize_dict.json"], "key_exact": ["Common0093"], "match_mode": "exact", "invalidation_scope": "item", "basis": "Common0093 is the generic Off toggle label. Exact-key scope intentionally distinguishes it from Common0007 Close despite identical zh-CN source text."},
