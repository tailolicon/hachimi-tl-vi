...
"""Canonicalize Mejiro Bright's 麗しき花信風 / 优雅清风待花开 unique Skill."""
...
SOURCE_JA = "麗しき花信風"
PREFERRED = SOURCE_JA
TERM_ID = "skill.mejiro_bright.uruwashiki_kashinfu"
...
TERM = {
    ...
    "match_mode": "contains",
    "basis": (
        "Pinned Skill 100741 is Mejiro Bright's unique Skill 麗しき花信風. "
...
DECISION = {
    "decision_id": "audit.finding.skill-mejiro-bright-uruwashiki-kashinfu",
    ...
    "ja": [SOURCE_JA],
    "note": (
        "Verified pinned Skill 100741 as Mejiro Bright's JP unique Skill 麗しき花信風. "
...
def main() -> int:
    changed = harden(ROOT)
    print(f"mejiro_bright_kashinfu_hardening_changed={str(changed).lower()}")
    return 0
