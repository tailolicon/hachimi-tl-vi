...
"""Resolve the regenerated source-path-wide Aoharu Ignition finding from live evidence."""
...
FINDING_ID = "cf-7894d0578d8c8a02"
TERM_ID = "skill.aoharu_ignition.family"
TARGET = "Thắp lửa thanh xuân"
...
def main() -> int:
    ...
    print(f"regenerated_aoharu_ignition_resolution_changed={str(changed).lower()}")
    return 0
