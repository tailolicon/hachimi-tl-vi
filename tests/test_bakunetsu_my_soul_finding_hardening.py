...
from scripts.harden_bakunetsu_my_soul_finding import (
    DECISION_ID,
    FINDING_ID,
    RULE_ID,
    SOURCE,
...
def test_hardener_resolves_bakunetsu_my_soul_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "My Soul bùng cháy" in rule["forbidden"]
