...
from scripts.harden_fuwamoko_hour_finding import (
    DECISION,
    FINDING_ID,
    HISTORICAL_TARGET,
    RULE,
...
def test_hardener_resolves_fuwamoko_hour_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert resolved["canonical_resolution"] == {
        "layer": "community",
        "term_id": "skill.aston_machan.fuwamoko_hour.preserve_japanese_title",
        "target_vi": TARGET,
    }
