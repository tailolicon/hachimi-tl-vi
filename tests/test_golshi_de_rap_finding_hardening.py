...
from scripts.harden_golshi_de_rap_finding import (
    DECISION_ID,
    FINDING_ID,
    RULE_ID,
    SOURCE,
...
def test_hardener_resolves_golshi_de_rap_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Rap cùng Golshi -It's không thể đâu-" in rule["forbidden"]
