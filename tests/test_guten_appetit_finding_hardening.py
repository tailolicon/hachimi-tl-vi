...
from scripts.harden_guten_appetit_finding import DECISION, FINDING_ID, HISTORICAL_TARGET, RULE, SOURCE_JA, SOURCE_ZH, TARGET, harden
...
def test_hardener_resolves_guten_appetit_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
