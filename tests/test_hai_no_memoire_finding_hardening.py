...
from scripts.harden_hai_no_memoire_finding import DECISION_ID, FINDING_ID, RULE_ID, SOURCE_JA, SOURCE_ZH, TARGET, harden
...
def test_hardener_resolves_hai_no_memoire_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Memoire màu tro" in rule["forbidden"]
