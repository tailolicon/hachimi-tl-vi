...
from scripts.harden_hello_polaris_finding import DECISION_ID, FINDING_ID, RULE_ID, SOURCE_JA, SOURCE_ZH, TARGET, harden
...
def test_hardener_resolves_hello_polaris_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert rule["forbidden"] == [SOURCE_ZH]
