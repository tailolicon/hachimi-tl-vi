...
from scripts.harden_hishi_miracle_small_miracle_for_you_finding import (
    DECISION_ID,
    FINDING_ID,
    RULE_ID,
    SOURCE_JA,
...
def test_hardener_resolves_small_miracle_unique_skill_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Tặng bạn một kỳ tích bé nhỏ♪" in rule["forbidden"]
