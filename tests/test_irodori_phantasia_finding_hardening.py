...
from scripts.harden_irodori_phantasia_finding import (
    DECISION_ID,
    FINDING_ID,
    RULE_ID,
    SOURCE,
...
def test_hardener_resolves_irodori_phantasia_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Sắc màu Phantasia" in rule["forbidden"]
