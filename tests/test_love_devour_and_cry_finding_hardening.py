...
from scripts.harden_love_devour_and_cry_finding import DECISION_ID, FINDING_ID, RULE_ID, SOURCE_JA, SOURCE_ZH, TARGET, harden
...
def test_hardener_resolves_love_devour_and_cry_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Múa vì yêu, muốn nuốt trọn." in rule["forbidden"]
