...
from scripts.harden_mejiro_bright_character_piece_finding import DECISION_ID, FINDING_ID, RULE_ID, SOURCE_ZH, TARGET, harden
...
def test_hardener_resolves_mejiro_bright_character_piece_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
