...
from scripts.harden_mochitto_harehare_finding import (
    DECISION,
    FINDING_ID,
    HISTORICAL_TARGET,
    RULE,
...
def test_hardener_resolves_mochitto_harehare_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert resolved["canonical_resolution"] == {
        "layer": "community",
        "term_id": "skill.nice_nature.mochitto_harehare.preserve_japanese_title",
        "target_vi": TARGET,
    }
