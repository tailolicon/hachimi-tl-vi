...
from scripts.harden_pisupisu_supisupi_golshi_song_finding import (
    DECISION_ID,
    FINDING_ID,
    RULE_ID,
    SOURCE,
...
def test_hardener_resolves_pisupisu_supisupi_song_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Bài ca Pisu Pisu☆Supi Supi của Golshi-chan" in rule["forbidden"]
