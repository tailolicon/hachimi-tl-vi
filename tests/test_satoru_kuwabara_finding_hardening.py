...
from scripts.harden_satoru_kuwabara_finding import DECISION, TERM, harden
...
def _finding(*, source_path: str = "text_data_dict.json") -> dict:
    return {
        "finding_id": "cf-11755361f56a2ac3",
        "status": "open",
        "source_zh_cn": "桑原聖",
        "match_mode": "contains",
...
def test_hardener_resolves_satoru_kuwabara_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
