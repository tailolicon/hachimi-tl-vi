...
from scripts.harden_shunsuke_tanaka_finding import DECISION, PREFERRED, SOURCE, TERM, harden

FINDING_ID = "cf-2d359ed052159dea"
...
def test_hardener_resolves_shunsuke_tanaka_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
