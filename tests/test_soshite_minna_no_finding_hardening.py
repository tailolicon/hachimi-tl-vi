...
from scripts.harden_soshite_minna_no_finding import (
    DECISION_ID,
    FINDING_ID,
    RULE_ID,
    SOURCE,
...
def test_hardener_resolves_soshite_minna_no_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Và rồi, của mọi người" in rule["forbidden"]
