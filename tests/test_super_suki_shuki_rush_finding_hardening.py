...
from scripts.harden_super_suki_shuki_rush_finding import (
    DECISION_ID,
    FINDING_ID,
    RULE_ID,
    SOURCE_JA,
...
def test_hardener_resolves_super_suki_shuki_rush_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Siêu mê♡Xung kích hết mình!" in rule["forbidden"]
