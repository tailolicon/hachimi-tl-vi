...
from scripts.harden_takuya_sakai_finding import DECISION, TERM, harden
...
def _finding(*, source_path: str = "text_data_dict.json") -> dict:
    return {
        "finding_id": "cf-6c4de5e15773b46d",
        "status": "open",
        "source_zh_cn": "酒井拓也",
        "match_mode": "contains",
...
def test_hardener_resolves_takuya_sakai_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
