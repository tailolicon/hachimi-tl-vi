...
from scripts.harden_tap_dance_city_billions_of_stars_finding import (
    DECISION_ID,
    FINDING_ID,
    RULE_ID,
    SOURCE_JA,
...
def test_hardener_resolves_billions_of_stars_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Trời đầy sao" in rule["forbidden"]
