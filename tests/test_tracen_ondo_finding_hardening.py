...
from scripts.harden_tracen_ondo_finding import (
    DECISION_ID,
    FINDING_ID,
    RULE_ID,
    SOURCE,
...
def test_hardener_resolves_tracen_ondo_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
    ...
    assert "Điệu ondo Tracen" in rule["forbidden"]
