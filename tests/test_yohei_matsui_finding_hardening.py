...
from scripts.harden_yohei_matsui_finding import DECISION, TERM, harden
...
def _finding(*, source_path: str = "text_data_dict.json") -> dict:
    return {
        "finding_id": "cf-ff1b53486e8bf6a1",
        "status": "open",
        "source_zh_cn": "松井洋平",
        "match_mode": "contains",
...
def test_hardener_resolves_yohei_matsui_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
