...
from scripts.harden_yoshie_isogai_finding import DECISION, TERM, harden
...
def _finding(*, source_path: str = "text_data_dict.json") -> dict:
    return {
        "finding_id": "cf-22866249b6932153",
        "status": "open",
        "source_zh_cn": "磯谷佳江",
        "match_mode": "contains",
...
def test_hardener_resolves_yoshie_isogai_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
