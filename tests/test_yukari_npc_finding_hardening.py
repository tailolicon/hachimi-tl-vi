...
from scripts.harden_yukari_npc_finding import DECISION, SOURCE, harden
...
def test_hardener_is_idempotent_and_all_item_scopes_clear_finding(tmp_path: Path) -> None:
    ...
    _write(tmp_path / "glossary" / "canonical_findings.json", {"schema_version": 1, "findings": [{
        "finding_id": "cf-6d1975b18f24e5ca", "status": "open", "source_zh_cn": SOURCE,
        "match_mode": "exact", "source_paths": ["text_data_dict.json"], "key_exact": [],
        "json_path_prefixes": [["152"]], "canonical_resolution": None, "review_resolution": None,
    }]})
