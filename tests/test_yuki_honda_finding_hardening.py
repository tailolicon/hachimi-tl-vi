...
from scripts.harden_yuki_honda_finding import DECISION, TERM, harden
...
def _finding(*, source_path: str = "text_data_dict.json") -> dict:
    return {
        "finding_id": "cf-717fc2fcbcfabe38",
        "status": "open",
        "source_zh_cn": "本多友紀",
        "match_mode": "contains",
...
def test_hardener_resolves_yuki_honda_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
