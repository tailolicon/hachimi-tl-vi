...
from scripts.harden_yume_no_saki_e_todoke_finding import DECISION, FINDING_ID, HISTORICAL_TARGET, RULE, SOURCE_JA, SOURCE_ZH, TARGET, harden
...
def test_hardener_resolves_yume_no_saki_e_todoke_and_is_idempotent(tmp_path: Path) -> None:
    _seed(tmp_path)
