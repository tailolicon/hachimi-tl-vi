...
- Batch: `batch-01067-s02`, 20 entries (`entry_index` 40–59)
- Result: `work/parallel/zhcn-67f8551f7780/results/b0010/batch-01067-s02.json`
- Completion marker: `work/parallel/zhcn-67f8551f7780/completed/b0010/batch-01067-s02.json`
- Validation: pinned source identity, completion-marker schema, structural QA, and persistent quality guard passed for all 20 entries.
